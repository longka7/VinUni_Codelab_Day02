...
# Standard Model Identifier (Updated to supported Gemini model)
GEMINI_MODEL = "gemini-3.6-flash"
# Candidate models used as fallbacks when calling the API
CANDIDATE_MODELS = [GEMINI_MODEL, "gemini-2.5-pro", "gemini-2.5-flash-lite"]
...
def evaluate_prompt(user_input: str) -> str:
    ...
    # Try Google GenAI SDK (Preferred Standard)
    ...
    # List of candidate models in case of deprecation
    ...
    for model_name in candidate_models:
        try:
            ...
            last_err = err
            if "404" in str(err) or "not available" in str(err):
                continue
            raise err
            
    raise last_err if last_err else RuntimeError("Failed to call Gemini API")
...
if __name__ == "__main__":
    ...
    if not api_key:
        ...
        print("Please set it in .env file or environment before running.")
        sys.exit(1)
        
    print("\033[94m==================================================")
    print("🚀 Vin Smart Future — Programmatic Boundary Stress-Testing")
    print(f"Standard Model: {GEMINI_MODEL} — Candidate models: {CANDIDATE_MODELS}")
    print("==================================================\033[0m\n")
